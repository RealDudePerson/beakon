...
print_info "Creating app.cfg..."

mkdir -p webserver/instance

cat > webserver/app.cfg << EOF
# Beakon Configuration
# Generated by setup script on $(date)

DEBUG=True

SQLALCHEMY_DATABASE_URI='sqlite:///$SCRIPT_DIR/webserver/instance/beakon.db'
...
print_success "Configuration saved to webserver/app.cfg"
...
Type=simple
WorkingDirectory=%s
ExecStart=%s/.venv/bin/python webserver/app.py
Restart=on-failure
RestartSec=5
...
echo -e "  ${BLUE}python webserver/app.py${NC}"
echo ""
...
echo -e "  ${YELLOW}webserver/app.cfg${NC}"
